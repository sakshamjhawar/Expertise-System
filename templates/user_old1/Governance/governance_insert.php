...
<p class="div_book_field_text" style="color:red; display: block;"><b>Enter the details of Governance</b></p>
        ...
        <input class="book_form_input" type="date" name="served_from" id="served_from" required="required">
         <script>
		document.getElementById('served_from').value = new Date().toISOString().substring(0, 10);
	</script>
        <br/>
        <br/>
        ...
        <script>
		document.getElementById('served_to').value = new Date().toISOString().substring(0, 10);
	</script>
        <br/>
        <br/>
