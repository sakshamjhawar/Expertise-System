<script type='text/javascript' >
	...
	$.ajax({
		  type: "POST",
		  url: "Governance/governance_delete_back.php",
...
<form>
<p class='div_award_field_text' style='color:red; display: block;'><b>Enter the Governance details to filter search results</b></p>
