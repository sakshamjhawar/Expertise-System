...
<script type='text/javascript' >
	...
	function fetch_data()
	{
		...
		//alert(membership_number + name + membership_type + from_date + to_date);
		$.ajax({
		  type: "POST",
		  ...
		  data: { membership_number:membership_number, name:name, membership_type:membership_type, from_date:from_date, to_date:to_date}
				...
				data = d.split("|");
				if(data.length > 1){
document.getElementById("prof_delete").innerHTML = '<table class = "div_table_award_overview"><tr><td class = "div_table_award_overview_th">Membership number</td><td class = "div_table_award_overview_th">Name</td><td class = "div_table_award_overview_th">Type</td><td class = "div_table_award_overview_th">Starting date</td><td class = "div_table_award_overview_th">End date</td>						</tr><tbody id="table_body"></tbody>				</table>    			<br>  			<br><input type="button" class="form_button_register_page_submit" value="Delete"  onClick="delete_data()"  style="margin-left:80%; margin-top: 8%; outline:none">';
	...
	$.ajax({
		  type: "POST",
		  url: "Professional_membership/prof_delete_back.php",
...
<form>
<!--<p class="div_book_field_text" style="color:red; display: block;"><b>Enter the details of Professional_Membership</b></p>
-->
