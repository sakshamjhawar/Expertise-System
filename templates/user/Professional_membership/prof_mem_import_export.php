...
var xls_file = function(){
	$("#a_export").attr("href", "Professional_membership/prof_export_xls_back.php");
}

var csv_file = function(){
	$("#a_export").attr("href", "Professional_membership/prof_export_csv_back.php");
}
...
// 	alert("here");
	$.ajax({
		url: "Professional_membership/prof_import_back.php",
		type: "POST",
		data: formdata,
		processData: false,
		contentType: false,
...
<div class = "form_export">
    ...
    <a id = "a_export" ><button class = "form_export_btn">Export</button></a>
