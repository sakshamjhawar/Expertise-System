...
var xls_file = function(){
	$("#a_export").attr("href", "individual/Award/award_export_xls_back.php");
}

var csv_file = function(){
	$("#a_export").attr("href", "individual/Award/award_export_csv_back.php");
}
...
// 	alert("here");
	$.ajax({
		url: "individual/Award/award_import_back.php",
		type: "POST",
		data: formdata,
		processData: false,
		contentType: false,
...
<form name = "data" id = "data" action = "individual/Award/award_import_export_back.php" method="post" enctype="multipart/form-data">
...
<div class = "form_export">
    ...
    <a id = "a_export" href = "individual/Award/award_export_csv_back.php"><button class = "form_export_btn">Export</button></a>
