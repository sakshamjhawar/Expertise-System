...
var xls_file = function(){
	$("#a_export").attr("href", "Seminar/seminar_export_xls_back.php");
}

var csv_file = function(){
	$("#a_export").attr("href", "Seminar/seminar_export_csv_back.php");
}
...
// 	alert("here");
	$.ajax({
		url: "Seminar/seminar_import_back.php",
		type: "POST",
		data: formdata,
		processData: false,
		contentType: false,
...
<div class = "form_export">
    ...
    <a id = "a_export" href = "Seminar/seminar_export_csv_back.php"><button class = "form_export_btn">Export</button></a>
