...
var xls_file = function(){
	$("#a_export").attr("href", "FacultyExchangeProgram/fep_export_xls_back.php");
}

var csv_file = function(){
	$("#a_export").attr("href", "FacultyExchangeProgram/fep_export_csv_back.php");
}
...
// 	alert("here");
	$.ajax({
		url: "FacultyExchangeProgram/fep_import_back.php",
		type: "POST",
		data: formdata,
		processData: false,
		contentType: false,
