...
<p class="div_book_field_text" style="color:red; display: block;"><b>Enter the details of Projects Done</b></p>
        ...
        <script>
		document.getElementById('close_date').value = new Date().toISOString().substring(0, 10);
	</script>
        <br/>
        <br/>
        ...
        <span id="star">*</span>
        <input class="book_form_input" type="number" name="project_cost" id="project_cost" size=50>
        <br/>
        <br/>
