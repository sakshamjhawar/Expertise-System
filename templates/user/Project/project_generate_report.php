...
<script type='text/javascript' >
	...
	function fetch_data()
	{
		...
		$.ajax({
			...
			//alert(d);
				data = d.split(";");
				if(data.length > 1){
				document.getElementById("book_delete").innerHTML = '<p><b><center> Select the Projects to print</center></b></p><br><table class = "div_table_award_overview" cellpadding = "15">\  \
				<tr> \
    			...
    			<br>\
    			<br>\
    			<input type="button" class="form_button_register_page_submit" value="Print"  style="margin-left:75%; margin-top: 8%; outline:none" onClick="delete_data()">';
	...
	$.ajax({
		  type: "POST",
		  url: "Project/project_generate_report_back.php",
