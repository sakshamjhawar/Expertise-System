...
<script type='text/javascript' >
	...
	function fetch_data()
	{
		...
		$.ajax({
				...
				data = d.split(";");
				if(data.length > 1){
				document.getElementById("book_delete").innerHTML = '<p><b><center> Select the Projects to delete</center></b></p><br><table class = "div_table_award_overview" cellpadding = "15">\  \
				<tr> \
