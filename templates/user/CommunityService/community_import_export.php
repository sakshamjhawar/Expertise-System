...
var xls_file = function(){
	$("#a_export").attr("href", "CommunityService/community_export_xls_back.php");
}

var csv_file = function(){
	$("#a_export").attr("href", "CommunityService/community_export_csv_back.php");
}
...
// 	alert("here");
	$.ajax({
		url: "CommunityService/community_import_back.php",
		type: "POST",
		data: formdata,
		processData: false,
		contentType: false,
