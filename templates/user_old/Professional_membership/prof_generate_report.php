	...
	function fetch_data()
	{
		...
		$.ajax({
		  ...
		  data: { membership_number:membership_number, name:name, membership_type:membership_type,from_date:from_date, to_date:to_date}
				...
				data = d.split(",");
				if(data.length > 1){
				document.getElementById("prof_delete").innerHTML = '<table class = "div_table_award_overview">\
					<tr>\
						<td class = "div_table_award_overview_th">Membership #</td>\
						<td class = "div_table_award_overview_th">Name of Body</td>\
						<td class = "div_table_award_overview_th">Type</td>\
						<td class = "div_table_award_overview_th">Starting date</td>\
