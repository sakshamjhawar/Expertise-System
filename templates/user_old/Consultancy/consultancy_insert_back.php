...
error_reporting(E_ALL ^ E_DEPRECATED);
		...
		$result = mysql_query("select MAX(consultancy_id) from consultancy where id = '$id'");	
		$result = mysql_fetch_array($result);
		$result = $result['MAX(consultancy_id)'];
		
		$consultancy_id=(int)$result+1;
		...
		$sql="INSERT INTO `consultancy`(`consultancy_id`, `client`, `work_title`, `start_date`, `end_date`, `revenue_generated`, `summary`, `labs_allocated`, `url`, `id`) VALUES('$consultancy_id','$client','$work_title','$start_date','$end_date','$revenue_generated','$summary','$labs_allocated', '$url','$id')";
