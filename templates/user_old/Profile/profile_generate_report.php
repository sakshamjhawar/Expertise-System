...
--><p class='div_award_field_text'><b>Enter the Educational Qualification details to filter search results</b></p>
        ...
        <input class="book_form_input" type=name name="join_month" id="join_month">
        <br/>
        <br/>
		 
        <span class= "div_book_field_text">Join_Year</span>
        <input class="book_form_input" type=name name="join_year" id="join_year">
        <br/>
        <br/>
		 
        <span class= "div_book_field_text">Pass_Year</span>
        <input class="book_form_input" type=name name="pass_year" id="pass_year">
        <br/>
        <br/>
        
        <span class= "div_book_field_text">Percentage</span>
        <input class="book_form_input" type=name name="percentage" id="percentage">
        <br/>
        <br/>
...
<script type='text/javascript' >
		  ...
		  data: { qualification:qualification, institution:institution,location:location,university:university,join_month:join_month,join_year:join_year,pass_year:pass_year,percentage:percentage, class1:class1}
				...
				document.getElementById("community_delete").innerHTML = '<table class = "div_table_award_overview">\
					<tr>\
						...
						<td class = "div_table_award_overview_th">Class1</td>\
					</tr>\
        			<tbody id="table_body">\
        			</tbody>\
				</table>\
    			<br>\
    			<br>\
    			<input type="button" class="form_button_register_page_submit" value="Generate PDF"  onClick="delete_data()"  style="margin-left:80%; margin-top: 8%; outline:none">';
	...
	$.ajax({
		  type: "POST",
		  url: "individual/profile/profile_generate_report_back.php",
