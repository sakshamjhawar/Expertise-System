...
<script type='text/javascript' >
	...
	function fetch_data()
	{
		...
		$.ajax({
		  ...
		  data: { id:id, name:name, agency:agency, from_date : from_date, to_date : to_date }
				...
				//alert(data.length);
				if(data.length > 1){
				document.getElementById("award_delete").innerHTML = '<p><b><center> Select the awards to generate reports</center></b></p><br><table class = "div_table_award_overview" cellpadding = "15">\
					<tr>\
    			...
    			<br>\
    			<br>\
    			<input type="button" class="form_button_register_page_submit" value="Print PDF"  onClick="print_pdf()" style="margin-left:75%; margin-top: 8%; outline:none">';
	...
	$.ajax({
		  type: "POST",
		  url: "Award/award_generate_report_back.php",
